...
export class WalletError {
    ...
    public toString(): string {
        ...
        switch (this.errorCode) {
            ...
            case WalletErrorCode.API_BODY_REQUIRED: {
                return "This API endpoint requires the submission of a body for processing.";
            }
            case WalletErrorCode.API_BLOCKEXPLORER_DISABLED: {
            ...
            case WalletErrorCode.API_NODE_NOT_SYNCED: {
                return "Daemon must be synced to process this RPC method call, please retry when synced.";
            }
            case WalletErrorCode.API_INVALID_ARGUMENT: {
                return "An argument supplied could not be properly decoded.";
            }
            case WalletErrorCode.API_INTERNAL_ERROR: {
                return "An internal error occurred.";
            }
            case WalletErrorCode.API_TRANSACTION_POOL_INSERT_FAILED: {
                return "Could not add transaction to the transaction pool.";
            }
            case WalletErrorCode.API_BLOCK_NOT_ACCEPTED: {
                return "Could not add block candidate to blockchain.";
            }
            case WalletErrorCode.API_HASH_NOT_FOUND: {
